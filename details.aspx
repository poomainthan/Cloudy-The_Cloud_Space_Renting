...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div class="payment-online-form-left">
                    <form>
                        ...
                        <ul>
                            <li><input class="text-box-dark" type="radio" checked="checked" value="debit" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'debit';}">DEBIT CARD</li>
                            <li><input class="text-box-dark" type="radio" value="credit" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'credit';}">CREDIT CARD</li>
                        </ul>
                        <p><b><u>ONLINE PAYMENTS</u></b></p>
                        
                        <ul>
                            <li><input class="text-box-dark" type="radio" checked="checked" value="gpay" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'gpay';}">GPAY</li>
                            <li><input class="text-box-dark" type="radio" value="phonepay" required onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'phonepay';}">PHONEPAY</li>
                        </ul>
